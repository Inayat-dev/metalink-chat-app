...
<body>
    <div class="profile-container">
        <div class="profile-header">
            ...
            <div class="profile-picture">
                <?php
                    ...
                    $img = getUserProfileImage($_COOKIE['username']);
                    echo $img ? "<img src='$img'>" : '<img src="profile/default.jpg">';
                ?>
            </div>
            <h2 class="username"><?php echo $_COOKIE['username']; ?></h2>
            <p class="bio">
                <?php
        ...
        <div class="overview">
            <div class="overview_item">
                <h3>
                    <?php
                        include 'config.php';
                        $friends = mysqli_query($conn,"SELECT * FROM friends WHERE name = '".$_COOKIE['username']."'");
            ...
            <div class="overview_item">
                ...
                <?php
                        $status = mysqli_query($conn,"SELECT time FROM status WHERE username = '".$_COOKIE['username']."'");
        ...
        <div class="status_list">
            ...
            <?php
                include 'config.php';
                $status = mysqli_query($conn,"SELECT * FROM status WHERE username ='".$_COOKIE['username']."'");
    ...
    <div class="bottom-nav">
        ...
        <div class="icon" style="color:#25d366;" onclick="window.location.href='profile.php'">
            <i class="fas fa-user-circle"></i>
            <span class="icon-label" style="color:#25d366;">Profile</span>
        </div>
    </div>
